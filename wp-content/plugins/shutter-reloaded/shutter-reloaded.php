...
Description: BUGFIXED VERSION FROM LECACTUS. Darkens the current page and displays an image on top like Lightbox, Thickbox, etc. However this script is a lot smaller and faster.
Version: 2.2-beta
Author: Andrew Ozz
...
function srel_makeshutter() {
	...
	$url = '/wp-content/plugins/shutter-reloaded';
